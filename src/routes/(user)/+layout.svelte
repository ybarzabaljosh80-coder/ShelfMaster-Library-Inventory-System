<script lang="ts">
	...
	const borrowsPath = resolve('/borrows');
...
<div class="min-h-[100dvh] bg-[#FAFAF9] pb-12">
			...
			<div class="flex min-h-[100dvh] flex-col px-6 py-24">
				<div class="space-y-3">
					<a
						...
						class={`block translate-y-0 rounded-2xl px-4 py-3 text-3xl font-semibold tracking-tight opacity-100 transition-all duration-500 ${page.url.pathname === dashboardPath ? 'bg-[#E8F5EC] text-[#1B6B3A] ring-1 ring-[#1B6B3A]/15' : 'text-gray-900 hover:bg-white/70'}`}
					...
					<a
						...
						class={`block translate-y-0 rounded-2xl px-4 py-3 text-3xl font-semibold tracking-tight opacity-100 transition-all duration-500 ${page.url.pathname === booksPath ? 'bg-[#E8F5EC] text-[#1B6B3A] ring-1 ring-[#1B6B3A]/15' : 'text-gray-900 hover:bg-white/70'}`}
					...
					<a
						...
						class={`block translate-y-0 rounded-2xl px-4 py-3 text-3xl font-semibold tracking-tight opacity-100 transition-all duration-500 ${page.url.pathname === borrowsPath ? 'bg-[#E8F5EC] text-[#1B6B3A] ring-1 ring-[#1B6B3A]/15' : 'text-gray-900 hover:bg-white/70'}`}
	...
	<nav class="relative z-50 mt-4 px-4" aria-label="User primary">
		<div
